...
| 14i | F2.2 Break-Even / Precision Remediation | **A=+1.4486pp（failure 单位贡献）、B=−2.6833pp（recovery 单位贡献），day-等权 752 anchor days；analytic-MC parity max diff 0.0071pp（<0.02 gate），grid 复现 0 误差；point break-even FPR：0.135 / 0.270 / 0.405 / 0.540（TPR .25/.50/.75/1）；break-even precision **0.762**（旧 0.96 撤销）；CI-safe frontier：0.05 / 0.10 / 0.30 / 0.30；TPR=.75/FPR=.30 +0.284pp（CI [0.041,0.524] 显著正）；contradiction test PASS；classification 规则不变 → 仍 B**。**F2.1 旧 "96% precision"、"TPR=.5 容忍 8%" 已正式撤销。** | DEVELOPMENT DIAGNOSTIC（WAITING EXTERNAL AUDIT，未写入 README CURRENT TRUTH） | `[research/risk/FAILURE_STATE_F22.md](research/risk/FAILURE_STATE_F22.md)` |

...
if __name__ == '__main__':
    ...
    configs = [
        ...
        dict(top_n=15, max_levels=5, time_stop_days=None, label='Top15_5层'),
        dict(top_n=20, max_levels=5, time_stop_days=None, label='Top20_5层'),
        dict(top_n=30, max_levels=5, time_stop_days=None, label='Top30_5层'),
        dict(top_n=10, max_levels=5, time_stop_days=20, label='Top10_5层_时间止损20'),
        dict(top_n=10, max_levels=5, time_stop_days=40, label='Top10_5层_时间止损40'),
        dict(top_n=15, max_levels=5, time_stop_days=40, label='Top15_5层_时间止损40'),
        dict(top_n=20, max_levels=5, time_stop_days=40, label='Top20_5层_时间止损40'),
        dict(top_n=10, max_levels=4, time_stop_days=None, label='Top10_4层'),
        dict(top_n=20, max_levels=4, time_stop_days=None, label='Top20_4层'),
        dict(top_n=10, max_levels=3, time_stop_days=None, label='Top10_3层'),
    ]
    summary = []
    for cfg in configs:
        label = cfg.pop('label')
    ...
    sm.to_csv(os.path.join(PROJECT_ROOT, 'results', 'live_summary_r2.csv'), index=False)
    print('\n===== 汇总 =====', flush=True)
